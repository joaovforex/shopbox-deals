      ...
      <div className="mt-2 bg-accent/10 border border-accent/30 rounded-lg px-3 py-3 flex flex-wrap items-center justify-between gap-3">
        <div className="text-xs">
          ...
          <div className="text-muted-foreground">
            Pague apenas <span className="font-bold text-foreground">R$ 10,00</span> de frete (Pix) e mudamos seu pedido para entrega.
          </div>
        </div>
        <button
          type="button"
        ...
        <div className="p-5 border-b border-border flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Frete de <strong>R$ 10,00</strong> pago por Pix. Entregamos apenas em Curitiba e região metropolitana.
            </p>
          </div>
        ...
        <form onSubmit={onSubmit} className="p-5 space-y-3">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-end gap-2">
            ...
            >
              ...
              {loading ? "Abrindo..." : "Pagar R$ 10,00 (Pix)"}
            </button>
          </div>
        </form>
      </div>
