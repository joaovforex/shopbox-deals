...
async function assertAdmin(context: { supabase: { rpc: (name: "has_role", args: { _user_id: string; _role: "admin" | "catalog" | "fulfillment" | "manager" | "user" }) => Promise<{ data: unknown; error: unknown }> }; userId: string }) {
