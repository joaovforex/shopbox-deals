...
function LabelPage() {
  ...
  return (
    <>
      <style>{`
        @page { size: ${isPickup ? "A6" : "110mm 150mm"}; margin: ${isPickup ? "8mm" : "0"}; }
        @media print {
