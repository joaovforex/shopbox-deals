...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "shopbox · Super ofertas em Colombo" },
      { property: "og:description", content: "Loja shopbox: produtos com super desconto, pagamento no Pix, cartão ou parcelado." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "shopbox" },
      { property: "og:url", content: "https://shopboxonline.com" },
      { property: "og:image", content: "https://shopboxonline.com/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "shopbox" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "shopbox · Super ofertas em Colombo" },
      { name: "twitter:description", content: "Loja shopbox: produtos com super desconto, pagamento no Pix, cartão ou parcelado." },
      { name: "twitter:image", content: "https://shopboxonline.com/og-image.png" },
    ],
    links: [
