...
GRANT EXECUTE ON FUNCTION public.list_products_paged(text, text, integer, integer, text) TO anon;
GRANT EXECUTE ON FUNCTION public.list_products_paged(text, text, integer, integer, text) TO authenticated;
