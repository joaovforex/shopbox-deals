DROP FUNCTION IF EXISTS public.list_products_paged(text, text, integer, integer, text);
...
GRANT EXECUTE ON FUNCTION public.list_products_paged(text, text, integer, integer, text, numeric) TO anon, authenticated;